...
///#if GENERICS_WORK
///        //
///        // IArithmetic<Decimal> implementation
///        //
///
///        /// <internalonly/>
///        Decimal IArithmetic<Decimal>.AbsoluteValue(out bool overflowed) {
///            overflowed = false;
///            return new Decimal(this.lo, this.mid, this.hi, this.flags & ~SignMask);
///        }
///
///        /// <internalonly/>
///        Decimal IArithmetic<Decimal>.Negate(out bool overflowed) {
///            overflowed = false;
///            return new Decimal(this.lo, this.mid, this.hi, this.flags ^ SignMask);
///        }
///
///        /// <internalonly/>
///        Decimal IArithmetic<Decimal>.Sign(out bool overflowed) {
///            overflowed = false;
///            Decimal zero = Decimal.Zero;
///            return FCallCompare(ref this, ref zero);
///        }
///
///        /// <internalonly/>
///        Decimal IArithmetic<Decimal>.Add(Decimal addend, out bool overflowed) {
///            Decimal result = this;
///            overflowed = false;
///            FCallAddSubOverflowed(ref result, ref addend, DECIMAL_ADD, ref overflowed);
///            return result;
///        }
///
///        /// <internalonly/>
///        Decimal IArithmetic<Decimal>.Subtract(Decimal subtrahend, out bool overflowed) {
///            Decimal result = this;
///            overflowed = false;
///            FCallAddSubOverflowed(ref result, ref subtrahend, DECIMAL_NEG, ref overflowed);
///            return result;
///        }
///
///        /// <internalonly/>
///        Decimal IArithmetic<Decimal>.Multiply(Decimal multiplier, out bool overflowed) {
///            Decimal result = this;
///            overflowed = false;
///            FCallMultiplyOverflowed(ref result, ref multiplier, ref overflowed);
///            return result;
///        }
///
///
///        /// <internalonly/>
///        Decimal IArithmetic<Decimal>.Divide(Decimal divisor, out bool overflowed) {
///            Decimal result = this;
///            overflowed = false;
///            FCallDivideOverflowed(ref result, ref divisor, ref overflowed);
///            return result;
///        }
///
///        /// <internalonly/>
///        Decimal IArithmetic<Decimal>.DivideRemainder(Decimal divisor, out Decimal remainder, out bool overflowed) {
///            Decimal result = this;
///            overflowed = false;
///            FCallDivideOverflowed(ref result, ref divisor, ref overflowed);
///            try {
///                remainder = Decimal.Remainder(this, divisor);
///            }
...
///
///        /// <internalonly/>
///        Decimal IArithmetic<Decimal>.Remainder(Decimal divisor, out bool overflowed) {
///            overflowed = false;
///
///            try {
///                return Decimal.Remainder(this, divisor);               
///            }
///            catch (OverflowException) {
///                overflowed = true;
///                return this;
...
///
///        /// <internalonly/>
///        ArithmeticDescriptor<Decimal> IArithmetic<Decimal>.GetDescriptor() {
///            if (s_descriptor == null) {
///                s_descriptor = new DecimalArithmeticDescriptor( ArithmeticCapabilities.One
...
///        }
///
///        private static DecimalArithmeticDescriptor s_descriptor;
/// 
///        class DecimalArithmeticDescriptor : ArithmeticDescriptor<Decimal> {
///            public DecimalArithmeticDescriptor(ArithmeticCapabilities capabilities) : base(capabilities) {}
///
