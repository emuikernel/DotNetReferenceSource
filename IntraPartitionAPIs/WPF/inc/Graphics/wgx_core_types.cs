...
{                                   
    ...
    /* 0x39 */ MilCmdGlyphRunCreate                          = 0x39,
    /* 0x3a */ MilCmdDoubleBufferedBitmap                    = 0x3a,
    /* 0x3b */ MilCmdDoubleBufferedBitmapCopyForward         = 0x3b,
    ...
    /* 0x3c */ MilDrawLine                                   = 0x3c,
    /* 0x3d */ MilDrawLineAnimate                            = 0x3d,
    /* 0x3e */ MilDrawRectangle                              = 0x3e,
    /* 0x3f */ MilDrawRectangleAnimate                       = 0x3f,
    /* 0x40 */ MilDrawRoundedRectangle                       = 0x40,
    /* 0x41 */ MilDrawRoundedRectangleAnimate                = 0x41,
    /* 0x42 */ MilDrawEllipse                                = 0x42,
    /* 0x43 */ MilDrawEllipseAnimate                         = 0x43,
    /* 0x44 */ MilDrawGeometry                               = 0x44,
    /* 0x45 */ MilDrawImage                                  = 0x45,
    /* 0x46 */ MilDrawImageAnimate                           = 0x46,
    /* 0x47 */ MilDrawGlyphRun                               = 0x47,
    /* 0x48 */ MilDrawDrawing                                = 0x48,
    /* 0x49 */ MilDrawVideo                                  = 0x49,
    /* 0x4a */ MilDrawVideoAnimate                           = 0x4a,
    /* 0x4b */ MilPushClip                                   = 0x4b,
    /* 0x4c */ MilPushOpacityMask                            = 0x4c,
    /* 0x4d */ MilPushOpacity                                = 0x4d,
    /* 0x4e */ MilPushOpacityAnimate                         = 0x4e,
    /* 0x4f */ MilPushTransform                              = 0x4f,
    /* 0x50 */ MilPushGuidelineSet                           = 0x50,
    /* 0x51 */ MilPushGuidelineY1                            = 0x51,
    /* 0x52 */ MilPushGuidelineY2                            = 0x52,
    /* 0x53 */ MilPushEffect                                 = 0x53,
    /* 0x54 */ MilPop                                        = 0x54,
    ...
    /* 0x55 */ MilCmdAxisAngleRotation3D                     = 0x55,
    /* 0x56 */ MilCmdQuaternionRotation3D                    = 0x56,
    /* 0x57 */ MilCmdPerspectiveCamera                       = 0x57,
    /* 0x58 */ MilCmdOrthographicCamera                      = 0x58,
    /* 0x59 */ MilCmdMatrixCamera                            = 0x59,
    /* 0x5a */ MilCmdModel3DGroup                            = 0x5a,
    /* 0x5b */ MilCmdAmbientLight                            = 0x5b,
    /* 0x5c */ MilCmdDirectionalLight                        = 0x5c,
    /* 0x5d */ MilCmdPointLight                              = 0x5d,
    /* 0x5e */ MilCmdSpotLight                               = 0x5e,
    /* 0x5f */ MilCmdGeometryModel3D                         = 0x5f,
    /* 0x60 */ MilCmdMeshGeometry3D                          = 0x60,
    /* 0x61 */ MilCmdMaterialGroup                           = 0x61,
    /* 0x62 */ MilCmdDiffuseMaterial                         = 0x62,
    /* 0x63 */ MilCmdSpecularMaterial                        = 0x63,
    /* 0x64 */ MilCmdEmissiveMaterial                        = 0x64,
    /* 0x65 */ MilCmdTransform3DGroup                        = 0x65,
    /* 0x66 */ MilCmdTranslateTransform3D                    = 0x66,
    /* 0x67 */ MilCmdScaleTransform3D                        = 0x67,
    /* 0x68 */ MilCmdRotateTransform3D                       = 0x68,
    /* 0x69 */ MilCmdMatrixTransform3D                       = 0x69,
    /* 0x6a */ MilCmdPixelShader                             = 0x6a,
    /* 0x6b */ MilCmdImplicitInputBrush                      = 0x6b,
    /* 0x6c */ MilCmdBlurEffect                              = 0x6c,
    /* 0x6d */ MilCmdDropShadowEffect                        = 0x6d,
    /* 0x6e */ MilCmdShaderEffect                            = 0x6e,
    /* 0x6f */ MilCmdDrawingImage                            = 0x6f,
    /* 0x70 */ MilCmdTransformGroup                          = 0x70,
    /* 0x71 */ MilCmdTranslateTransform                      = 0x71,
    /* 0x72 */ MilCmdScaleTransform                          = 0x72,
    /* 0x73 */ MilCmdSkewTransform                           = 0x73,
    /* 0x74 */ MilCmdRotateTransform                         = 0x74,
    /* 0x75 */ MilCmdMatrixTransform                         = 0x75,
    /* 0x76 */ MilCmdLineGeometry                            = 0x76,
    /* 0x77 */ MilCmdRectangleGeometry                       = 0x77,
    /* 0x78 */ MilCmdEllipseGeometry                         = 0x78,
    /* 0x79 */ MilCmdGeometryGroup                           = 0x79,
    /* 0x7a */ MilCmdCombinedGeometry                        = 0x7a,
    /* 0x7b */ MilCmdPathGeometry                            = 0x7b,
    /* 0x7c */ MilCmdSolidColorBrush                         = 0x7c,
    /* 0x7d */ MilCmdLinearGradientBrush                     = 0x7d,
    /* 0x7e */ MilCmdRadialGradientBrush                     = 0x7e,
    /* 0x7f */ MilCmdImageBrush                              = 0x7f,
    /* 0x80 */ MilCmdDrawingBrush                            = 0x80,
    /* 0x81 */ MilCmdVisualBrush                             = 0x81,
    /* 0x82 */ MilCmdBitmapCacheBrush                        = 0x82,
    /* 0x83 */ MilCmdDashStyle                               = 0x83,
    /* 0x84 */ MilCmdPen                                     = 0x84,
    /* 0x85 */ MilCmdGeometryDrawing                         = 0x85,
    /* 0x86 */ MilCmdGlyphRunDrawing                         = 0x86,
    /* 0x87 */ MilCmdImageDrawing                            = 0x87,
    /* 0x88 */ MilCmdVideoDrawing                            = 0x88,
    /* 0x89 */ MilCmdDrawingGroup                            = 0x89,
    /* 0x8a */ MilCmdGuidelineSet                            = 0x8a,
    /* 0x8b */ MilCmdBitmapCache                             = 0x8b,
    ...
    /* 0x8c */ MilCmdValidateStructureOrder                  = 0x8c
#endif
};
