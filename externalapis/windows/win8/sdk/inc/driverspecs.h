...
extern "C" {
    ...
    #define ___drv_unit_kernel_code                                           \
            _SA_annotes0(SAL_kernel) _SA_annotes0(SAL_nodriver)

    // Indicate that the code is kernel, driver, code.
    #define ___drv_unit_kernel_driver                                         \
            _SA_annotes0(SAL_kernel) _SA_annotes0(SAL_driver)

    // Indicate that the code is a user mode driver.
    #define ___drv_unit_user_driver                                           \
            _SA_annotes0(SAL_nokernel) _SA_annotes0(SAL_driver)

    // Indicate that the code is ordinary user mode code.
    #define ___drv_unit_user_code                                             \
            _SA_annotes0(SAL_nokernel) _SA_annotes0(SAL_nodriver)
    ...
    #define _Kernel_acquires_resource_(kind)                                  \
        _Post_ _SA_annotes1(SAL_acquire, #kind)
    ...
    #define _Kernel_releases_resource_(kind)                                  \
        _Post_ _SA_annotes1(SAL_release, #kind)
    ...
    #define _Kernel_requires_resource_held_(kind)                             \
        _Pre_ _SA_annotes1(SAL_mustHold, #kind)
    ...
    #define _Kernel_requires_resource_not_held_(kind)                                  \
        _Pre_ _SA_annotes1(SAL_neverHold, #kind)
    ...
    #define __drv_innerNeverHoldGlobal(kind, param)                           \
        _Pre_ _SA_annotes2(SAL_neverHoldGlobal, #kind, param\t)
    #define __drv_neverHoldGlobal(kind,param)                                 \
        _Requires_lock_not_held_(param)
    ...
    #define __drv_minIRQL _IRQL_requires_min_ /* legacy */

    //
    // The current IRQL is saved in the annotated parameter
    //
    #define _IRQL_saves_  /* see kernelspecs.h */
    #define __drv_savesIRQL _IRQL_saves_ /* legacy */
    ...
    #define __drv_savesIRQLGlobal _IRQL_saves_global_ /* legacy */

    //
    // The current IRQL is restored from the annotated parameter
    //
    #define _IRQL_restores_  /* see kernelspecs.h */
    #define __drv_restoresIRQL _IRQL_restores_ /* legacy */
    ...
    #define __drv_restoresIRQLGlobal _IRQL_restores_global_ /* legacy */
    ...
    #define __drv_minFunctionIRQL _IRQL_always_function_min_ /* legacy */

    //
    // The maximum IRQL to which the function can raise itself.
    //
    #define _IRQL_always_function_max_(irql)  /* see kernelspecs.h */
    #define __drv_maxFunctionIRQL _IRQL_always_function_max_  /* legacy */
    ...
    #define __drv_useCancelIRQL _IRQL_uses_cancel_ /* legacy */
    ...
    #define _Kernel_clear_do_init_(yesNo)                                     \
        _Post_ _SA_annotes1(SAL_clearDoInit,yesNo)
    #define __drv_clearDoInit _Kernel_clear_do_init_ /* legacy */
    ...
    #define _Kernel_IoGetDmaAdapter_                                          \
        _Post_ _SA_annotes0(SAL_IoGetDmaAdapter)
    #define __drv_IoGetDmaAdapter _Kernel_IoGetDmaAdapter_ /* legacy */
    ...
    #define __drv_valueIs(arglist)                                            \
            _Post_ _SA_annotes1(SAL_return,arglist)
    ...
    #define __drv_strictTypeMatch(mode)                                       \
        _Pre_ _SA_annotes1(SAL_strictTypeMatch,mode)
    ...
    #define __drv_strictType(typename,mode)                                   \
        _Pre_ _SA_annotes2(SAL_strictType, typename, mode)
    //
    ...
    // intended).
    #define __drv_notPointer _Pre_ _SA_annotes1(SAL_mayBePointer,__no)
    ...
    #define __drv_preferredFunction(func,why)                                 \
        _Pre_ _SA_annotes2(SAL_preferredFunction, func, why)
    ...
    #define __drv_reportError(why)                                            \
        _Pre_ _SA_annotes1(SAL_error,why)
    ...
    #define __drv_floatSaved _Kernel_float_saved_ /* legacy */
    ...
    #define __drv_floatRestored _Kernel_float_restored_ /* legacy */
    ...
    #define __drv_floatUsed _Kernel_float_used_ /* legacy */
    ...
    #define __drv_formatString(kind)\
        _SA_annotes1(SAL_IsFormatString, #kind)
    ...
    #define __drv_completionType(kindlist)\
        _SA_annotes1(SAL_completionType, #kindlist)
    ...
    #define __drv_callbackType(kind)\
        _SA_annotes1(SAL_callbackType, #kind)
    ...
    #define __drv_acquiresExclusiveResource(kind)                             \
        _Acquires_nonreentrant_lock_(_Curr_)

    #define __drv_releasesExclusiveResource(kind)                             \
        _Releases_nonreentrant_lock_(_Curr_)
