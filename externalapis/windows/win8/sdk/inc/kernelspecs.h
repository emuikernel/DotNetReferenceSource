...
extern "C" {
    ...
    #define __drv_setsIRQL(irql)                                              \
        _Post_ _SA_annotes1(SAL_IRQL,irql) /* legacy */
    ...
    #define _IRQL_raises_(irql)                                               \
        _Post_ _SA_annotes1(SAL_raiseIRQL,irql)
    ...
    #define _IRQL_requires_(irql)                                             \
        _Pre_ _SA_annotes1(SAL_IRQL,irql)
    ...
    #define _IRQL_requires_max_(irql)                                         \
        _Pre_ _SA_annotes1(SAL_maxIRQL,irql)
    #undef __drv_maxIRQL
    ...
    #define _IRQL_requires_min_(irql)                                         \
        _Pre_ _SA_annotes1(SAL_minIRQL,irql)
    #undef __drv_minIRQL
    ...
    #define _IRQL_always_function_min_(irql)                                  \
        _Pre_ _SA_annotes1(SAL_minFunctionIrql,irql)
    ...
    #define _IRQL_always_function_max_(irql)                                  \
        _Pre_ _SA_annotes1(SAL_maxFunctionIrql,irql)
