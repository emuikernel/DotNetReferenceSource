...
typedef UCHAR DOT11_----_OR_REGION_STRING[3];
typedef DOT11_----_OR_REGION_STRING * PDOT11_----_OR_REGION_STRING;
...
#define OID_DOT11_----_STRING                        (OID_DOT11_NDIS_START + 76)
    // UCHAR[3]
...
#define OID_DOT11_SUPPORTED_----_OR_REGION_STRING    NWF_DEFINE_OID(152,NWF_OPERATIONAL_OID,NWF_MANDATORY_OID)
    typedef struct DOT11_----_OR_REGION_STRING_LIST {
        #define DOT11_----_OR_REGION_STRING_LIST_REVISION_1  1
        NDIS_OBJECT_HEADER Header;
        ULONG uNumOfEntries;
        ULONG uTotalNumOfEntries;
        DOT11_----_OR_REGION_STRING ----OrRegionStrings[1];
    } DOT11_----_OR_REGION_STRING_LIST, * PDOT11_----_OR_REGION_STRING_LIST;

#define OID_DOT11_DESIRED_----_OR_REGION_STRING      NWF_DEFINE_OID(153,NWF_OPERATIONAL_OID,NWF_MANDATORY_OID)
    // DOT11_----_OR_REGION_STRING
...
struct DOT11_EXTSTA_ATTRIBUTES {
    ...
    // Supported ---- Strings
    ULONG uNumSupported----OrRegionStrings;
    #ifdef __midl
    [size_is(uNumSupported----OrRegionStrings)]
    #endif
    PDOT11_----_OR_REGION_STRING pSupported----OrRegionStrings;
...
DEFINE_NWF_GUID(GUID_NWF_----_STRING,76);
...
DEFINE_NWF_GUID(GUID_NWF_SUPPORTED_----_OR_REGION_STRING,152);
DEFINE_NWF_GUID(GUID_NWF_DESIRED_----_OR_REGION_STRING,153);
...
{
    DOT11_----_OR_REGION_STRING ----RegionString;
