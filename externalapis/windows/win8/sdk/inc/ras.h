...
RASPPPIPW
{
    DWORD dwSize;
    DWORD dwError;
    WCHAR szIpAddress[ RAS_----dress + 1 ];
    ...
    */
    WCHAR szServerIpAddress[ RAS_----dress + 1 ];
...
RASPPPIPA
{
    DWORD dwSize;
    DWORD dwError;
    CHAR  szIpAddress[ RAS_----dress + 1 ];

#ifndef WINNT35COMPATIBLE

    /* See RASPPPIPW comment.
    */
    CHAR  szServerIpAddress[ RAS_----dress + 1 ];
...
/* RAS ---- information (currently retrieved from TAPI).
*/
...
*/
#define RASEO_Use----AndAreaCodes    0x00000001
...
*/
#define R----UBENTRYA struct tagR----UBENTRYA
R----UBENTRYA
{
    DWORD       dwSize;
    DWORD       dwfFlags;
...
#define R----UBENTRYW struct tagR----UBENTRYW
R----UBENTRYW
{
    DWORD       dwSize;
    DWORD       dwfFlags;
...
#ifdef UNICODE
#define R----UBENTRY R----UBENTRYW
#else
#define R----UBENTRY R----UBENTRYA
#endif

#define LPR----UBENTRYW R----UBENTRYW*
#define LPR----UBENTRYA R----UBENTRYA*
#define LPR----UBENTRY  R----UBENTRY*
...
DWORD APIENTRY RasGet----InfoA( _Inout_opt_ LPRASCTRYINFOA, _Inout_ LPDWORD );

DWORD APIENTRY RasGet----InfoW( _Inout_opt_ LPRASCTRYINFOW, _Inout_ LPDWORD );
...
DWORD APIENTRY RasGetSubEntryPropertiesA( _In_opt_ LPCSTR, _In_ LPCSTR, _In_ DWORD,
                    _Inout_opt_  LPR----UBENTRYA, _Inout_opt_ LPDWORD, _Out_opt_  LPBYTE, _Inout_opt_ LPDWORD );

DWORD APIENTRY RasGetSubEntryPropertiesW( _In_opt_ LPCWSTR, _In_ LPCWSTR, _In_ DWORD,
                    _Inout_opt_ LPR----UBENTRYW, _Inout_opt_ LPDWORD, _Out_opt_ LPBYTE, _Inout_opt_ LPDWORD );

DWORD APIENTRY RasSetSubEntryPropertiesA( _In_opt_ LPCSTR, _In_ LPCSTR, _In_ DWORD, 
                    _In_ LPR----UBENTRYA, _In_ DWORD, _In_opt_  LPBYTE, _In_ DWORD );

DWORD APIENTRY RasSetSubEntryPropertiesW( _In_opt_ LPCWSTR, _In_ LPCWSTR, _In_ DWORD,
                    _In_ LPR----UBENTRYW, _In_ DWORD, _In_opt_  LPBYTE, _In_ DWORD );
...
#define RasGet----Info           RasGet----InfoW
...
#define RasGet----Info           RasGet----InfoA
