...
*
*Revision History:
*       11-03-04  ATC   Created.
*       11-23-04  ATC   Added SAL annotations to CRT headers.
*       12-01-04  AC    Removed temporary workaround now that specstrings.h is up to date.
*       12-13-04  AC    Added history and formatted the header comments.
*       12-22-04  AC    Fixed integration.
*       01-11-05  DAB   Added temporary workaround to disable macro redefinition warning in specstrings.h
*       01-14-05  AC    Fixed a bunch of macros and modified the workaround for specstrings.h
*       01-18-05  DAB   Removed _awcount macros, and removed workaround for C4005
*       03-23-05  MSL   Made compatible with C compilation
*       04-05-05  AC    Add __out_nz and __out_nz_opt
*       05-27-05  MSL   Missing _z macro
*       06-17-05  [....]  Added macros __deref_in_xxx
*       06-17-06  HR    Adding Attribute based annotations
*       07-10-06  gm    Reverted sal.h@1518961 since __deref_in is already defined in the SDK version
*                       of sal.h (from the redist msms).
*       07-16-07  STL   Added several _Deref_<miscellaneous> macros.
*       07-29-08  HG    Added _Post_ptr_(in)valid_ macros.
*       12-18-09  TGANI Turned off SAL macro expansion in non-_PREFAST_ mode to fix perf.
*       01-27-12  DJS   Revise for SAL 2
****/
#pragma once
