...
INTERNETAPI_(DWORD) InternetConfirmZo----ssingA(
    _In_ HWND hWnd,
...
INTERNETAPI_(DWORD) InternetConfirmZo----ssingW(
    _In_ HWND hWnd,
...
#ifdef UNICODE
#define InternetConfirmZo----ssing  InternetConfirmZo----ssingW
#else
#ifdef _WINX32_
#define InternetConfirmZo----ssing  InternetConfirmZo----ssingA
#else
INTERNETAPI_(DWORD) InternetConfirmZo----ssing(
    _In_ HWND hWnd,
    _In_ LPSTR szUrlPrev,
    _In_ LPSTR szUrlNew,
    _In_ BOOL bPost
