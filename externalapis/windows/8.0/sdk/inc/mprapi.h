...
typedef _Struct_size_bytes_(dwSize + sizeof(MPR_CREDENTIAL----_0)) struct _MPR_CREDENTIAL----_0
{
    DWORD  dwSize;
    LPBYTE lpbCredentialsInfo;
}
MPR_CREDENTIAL----_0, *PMPR_CREDENTIAL----_0;

typedef _Struct_size_bytes_(dwSize + sizeof(MPR_CREDENTIAL----_1)) struct _MPR_CREDENTIAL----_1
{
    DWORD  dwSize;
    LPBYTE lpbCredentialsInfo;
}
MPR_CREDENTIAL----_1, *PMPR_CREDENTIAL----_1;
...
typedef struct _RAS_CONNECTION_EX {
    ...
    WCHAR                       wszRemoteEndpointAddress[----RESSLEN+1];
    WCHAR                       wszLocalEndpointAddress[----RESSLEN+1];
...
MprAdminInterfaceEnum(
    _In_      MPR_SERVER_HANDLE       hMprServer,
    _In_      DWORD                   dwLevel,
    _Outptr_result_bytebuffer_((*lpdwEntriesRead)*sizeof(MPR_INTERFACE_0)) LPBYTE *  lplpbBuffer,
    _In_      DWORD                   dwPrefMaxLen,
    _Out_     LPDWORD                 lpdwEntriesRead,
    _Out_     LPDWORD                 lpdwTotalEntries,
    _In_opt_  LPDWORD                 lpdwResumeHandle
