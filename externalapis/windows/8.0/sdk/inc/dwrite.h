...
enum DWRITE_FONT_FACE_TYPE
{
    ...
    /// minimum funtionality necessary to render glyphs.
    /// </summary>
...
struct DWRITE_FONT_METRICS
{
    ...
    /// Cap height is the distance from English baseline to the top of a typical English ----.
    /// ---- "H" is often used as a reference character for the purpose of calculating the cap height value.
    /// </summary>
    UINT16 capHeight;
...
enum DWRITE_FONT_FEATURE_TAG
{
    ...
    DWRITE_FONT_FEATURE_TAG_----_SPACING                     = 0x70737063, // 'cpsp'
...
enum DWRITE_NUMBER_SUBSTITUTION_METHOD
{
    ...
    /// <summary>
    /// If the culture is Arabic or ----, specifies that the number shape
