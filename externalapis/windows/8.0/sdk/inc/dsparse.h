...
// ==========================================================
// Ds----Spn() -- parse an SPN into the ServiceClass,
...
#ifdef UNICODE
#define Ds----Spn Ds----SpnW
#else
#define Ds----Spn Ds----SpnA
#endif
...
#ifdef UNICODE
#define Ds----UnquotedMangledRdn Ds----UnquotedMangledRdnW
#else
#define Ds----UnquotedMangledRdn Ds----UnquotedMangledRdnA
#endif
...
// ==========================================================
// Ds----Spn2() -- parse a counted-length SPN into the ServiceClass,
// ServiceName, and InstanceName (and InstancePort) pieces.
// An SPN is passed in, along with a pointer to the maximum length
// for each piece and a pointer to a buffer where each piece should go.
// On exit, the maximum lengths are updated to the actual length for each piece
...
#ifdef UNICODE
#define Ds----Spn2 Ds----Spn2W
#else
#define Ds----Spn2 Ds----Spn2A
#endif
