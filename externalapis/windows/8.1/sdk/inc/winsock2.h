...
#define XP1_G----FUL_CLOSE                  0x00000020
...
typedef
INT
(WSAAPI * LPFN_WSAENUMNAMESPACEPROVIDER----A)(
    _Inout_ LPDWORD              lpdwBufferLength,
    _Out_writes_bytes_to_(*lpdwBufferLength,*lpdwBufferLength) LPWSANAMESPACE_INFOEXA lpnspBuffer
    );
typedef
INT
(WSAAPI * LPFN_WSAENUMNAMESPACEPROVIDER----W)(
    _Inout_ LPDWORD              lpdwBufferLength,
    _Out_writes_bytes_to_(*lpdwBufferLength,*lpdwBufferLength) LPWSANAMESPACE_INFOEXW lpnspBuffer
    );
#ifdef UNICODE
#define LPFN_WSAENUMNAMESPACEPROVIDER----  LPFN_WSAENUMNAMESPACEPROVIDER----W
#else
#define LPFN_WSAENUMNAMESPACEPROVIDER----  LPFN_WSAENUMNAMESPACEPROVIDER----A
#endif /* !UNICODE */
