...
#define _Benign_----_begin_ __pragma(warning(push)) __pragma(warning(disable:26100 26101 26150 26130 26180 26131 26181 28112))
#define _Benign_----_end_ __pragma(warning(pop))
...
#define BENIGN_----_BEGIN __pragma(warning(push)) __pragma(warning(disable:26100 26150 26130 26180 26131 26181))
#define BENIGN_----_END __pragma(warning(pop))
...
#define _Benign_----_begin_ __pragma(warning(push))
#define _Benign_----_end_ __pragma(warning(pop))
...
#define BENIGN_----_BEGIN __pragma(warning(push))
#define BENIGN_----_END __pragma(warning(pop))
