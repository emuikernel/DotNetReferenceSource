...
typedef HANDLE HDWP;
typedef VOID ME----EMPLATEA;
typedef VOID ME----EMPLATEW;
#ifdef UNICODE
typedef ME----EMPLATEW ME----EMPLATE;
#else
typedef ME----EMPLATEA ME----EMPLATE;
#endif // UNICODE
typedef PVOID LPME----EMPLATEA;
typedef PVOID LPME----EMPLATEW;
#ifdef UNICODE
typedef LPME----EMPLATEW LPME----EMPLATE;
#else
typedef LPME----EMPLATEA LPME----EMPLATE;
#endif // UNICODE
...
#define VK_OEM_PLUS       0xBB   // '+' any ----
#define VK_OEM_COMMA      0xBC   // ',' any ----
#define VK_OEM_MINUS      0xBD   // '-' any ----
#define VK_OEM_PERIOD     0xBE   // '.' any ----
...
WINAPI
LoadMenuIndirectA(
    _In_ CONST ME----EMPLATEA *lpMenuTemplate);
WINUSERAPI
HMENU
WINAPI
LoadMenuIndirectW(
    _In_ CONST ME----EMPLATEW *lpMenuTemplate);
#ifdef UNICODE
...
#define SPI_GETWINDOW----TENSION     0x005C
 ...
 *          ----n objects in their own right.  Like the thumb of a scrollbar.
