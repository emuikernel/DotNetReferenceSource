...
// joint-iso-itu-t(2) ----(16) us(840) organization(1) gov(101) csor(3) nistAlgorithms(4)  aesAlgs(1) }
...
//         identified-organization(3) tc68(133) ----(16) x9(840)
//         x9-63(63) schemes(0) }
...
// INFOSEC Algorithms
// joint-iso-ccitt(2) ----(16) us(840) organization(1) us-government(101) dod(2) id-infosec(1)
...
// joint-iso-itu-t(2) ----(16) us(840) organization(1) gov(101) csor(3) nistalgorithm(4) hashalgs(2)
...
#define szOID_----_NAME                  "2.5.4.6"  // printable 2char string
...
#define szOID_EV_RDN_----                        "1.3.6.1.4.1.311.60.2.1.3"
...
// Validation of the Locale (L), State (S), and ---- (C) fields in
...
//
//    To disable the above check, either set CERT_RDN_DISABLE_
...
//   Both CERT_STRONG_SIGN_ENABLE_CRL_
...
//              is a HCRYPTPROV handle to the private key ----oicated
...
//  this is the last CertCloseStore, set the CERT_CLOSE_STORE_
...
// dwErrorStatus bit: CERT_TRUST_HAS_NOT_SUPPORTED_
...
typedef struct _CERT_CHAIN_PARA {
    ...
    // CERT_CHAIN_STRONG_SIGN_DISABLE_END_
...
//
//  MICROSOFT_ROOT_CERT_CHAIN_POLICY_
