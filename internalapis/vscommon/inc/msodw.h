...
// name of the heap dump in watson cabs in exception mode
#define DW_HEAP_FILE_NAMEA   "memory.dmp"
#define DW_HEAP_FILE_NAME    DW_Y(DW_HEAP_FILE_NAMEA)
...
#define DEFAULT_SUBPATH "Microsoft\\PCHealth\\ErrorReporting\\DW"
