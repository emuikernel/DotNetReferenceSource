...
EXTERN_C const IID IID_IWebFileCtxService;
    ...
    public:
        ...
        virtual HRESULT STDMETHODCALLTYPE GetCodeEventBinding( 
            /* [in] */ VSITEMID itemID,
            /* [in] */ BOOL fPreferDTECodeModel,
            /* [out] */ __RPC__deref_out_opt IUnknown **ppUnkCodeEventBinding) = 0;
    ...
    typedef struct IWebFileCtxServiceVtbl
    {
        ...
        HRESULT ( STDMETHODCALLTYPE *GetCodeEventBinding )( 
            __RPC__in IWebFileCtxService * This,
            /* [in] */ VSITEMID itemID,
            /* [in] */ BOOL fPreferDTECodeModel,
            /* [out] */ __RPC__deref_out_opt IUnknown **ppUnkCodeEventBinding);
...
#define IWebFileCtxService_GetCodeEventBinding(This,itemID,fPreferDTECodeModel,ppUnkCodeEventBinding)	\
    ( (This)->lpVtbl -> GetCodeEventBinding(This,itemID,fPreferDTECodeModel,ppUnkCodeEventBinding) ) 
