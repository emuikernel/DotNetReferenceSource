...
__MACHINE(long __cdecl _InterlockedCompareExchange(long volatile * _Destination, long _Exchange, long _Comparand))
...
__MACHINE(long __cdecl _InterlockedDecrement(long volatile * _Addend))
...
__MACHINE(long __cdecl _InterlockedExchange(long volatile * _Target, long _Value))
...
__MACHINE(long __cdecl _InterlockedExchangeAdd(long volatile * _Addend, long _Value))
...
__MACHINE(long __cdecl  _InterlockedIncrement(long volatile * _Addend))
